<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateNewLayout.aspx.cs" Inherits="Idcards.Admin.CreateNewLayout" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="content" class="clearfix">
            <div id="ctl00_masterpageErrorMessage" class="masterpage-error-message">
                <div class="message">
                    Create Layout Failed. Possible reason(s):
                    <ul>
        ...
        <div class="accountInfo">
            <fieldset class="login">
                <legend>Create New Layout</legend>
                ...
                <asp:Panel ID="PnlLocked" runat="server" >
                    <asp:CheckBox ID="cbxLocked" runat="server" Text="Locked" AutoPostBack="true" 
        ...
        <p class="submitButton">
            <asp:Button ID="btnCreateLayer" runat="server" Text="Create Layer" 
                TabIndex="82" onclick="btnCreateLayer_Click" CssClass="ButtonLarge"/>
        </p>
</asp:Content>
